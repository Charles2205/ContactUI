...
class Felix extends StatelessWidget {
  const Felix({ Key? key }) : super(key: key);
         ...
         width: 500,
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text("Felix Oppong",
              style: TextStyle(
                 fontWeight:FontWeight.w600,
                 fontSize:20)
                 ),
            ),
            const Text("TN , United States", 
                  style: TextStyle(
                 fontWeight:FontWeight.w600,
                 fontSize:16)),
              ...
              subtitle:const Text("+233 54 67 54 458"),
           ...
           const ListTile(
              ...
              subtitle: Text("Cewudzie0@gmail.com"),
