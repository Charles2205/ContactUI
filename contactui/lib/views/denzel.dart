...
class Denzel extends StatelessWidget {
  const Denzel({ Key? key }) : super(key: key);
         ...
         width: 500,
          ...
          children: [
            ...
            const Text("Kumasi ,Ghana", 
              ...
              subtitle:const Text("+256 743 67 97"),
